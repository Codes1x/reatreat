...
<template>
    <section class="bg-white rounded-2xl shadow-md p-6 md:p-10 max-w-3xl mx-auto text-gray-800 space-y-6 mb-20">
      ...
      <p class="text-center text-lg text-gray-700 max-w-xl mx-auto">
        Стоимость длительного проживания в ретритном центре «Соната» зависит от продолжительности аренды:
      </p>
      ...
      <p class="text-center text-sm text-gray-500 mt-4 italic">
        *Стоимость указана ориентировочная. Актуальные предложения уточняйте по контактам центра.
      </p>
    </section>
  </template>
